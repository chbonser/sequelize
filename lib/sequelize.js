...
const { enableQueryCache, disableQueryCache } = require('./dialects/postgres/query-cache');
...
/**
 * Disable query caching for SELECT sql statements for postgres.
 */
Sequelize.disableQueryCache = disableQueryCache;
