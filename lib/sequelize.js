...
const { enableQueryCache, getQueryCacheStatistics } = require('./dialects/postgres/query-cache');
...
/**
 * Enable query caching for SELECT sql statements for postgres.
 */
Sequelize.enableQueryCache = enableQueryCache;

/**
 * Return stats (total queries and cache hit count) for the query cache or void if cache was not enabled.
 */
Sequelize.getQueryCacheStatistics = getQueryCacheStatistics;
